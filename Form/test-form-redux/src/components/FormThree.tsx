...
import { addFormThreeData } from '../features/formSlice';''
...
function FormThree() {
  ...
  const onsubmit:SubmitHandler<InfoForm> = (data)=>{
    ...
    console.log(data);
    dispatch(addFormThreeData(data))
    console.log('done');

    // eslint-disable-next-line react-hooks/rules-of-hooks
    const storeData = useAppSelector((state)=> state.userForm.formTwo)
  ...
  return (
    <div>
      <h1 className='m-4 text-2xl font-semibold text-center capitalize'>Form three</h1>
