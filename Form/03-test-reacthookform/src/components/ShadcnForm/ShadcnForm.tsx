...
function ShadcnForm() {
  ...
  <div className="navbar-start">
    ...
    <a className="text-xl btn btn-ghost">Form</a>
  </div>
...
{/* nav bar end here */}
{/* Divider */}
<div className="flex flex-col w-full mt-12 lg:flex-row">
  <div className="grid flex-grow h-auto p-2 card rounded-box place-items-center">
        <ul className="steps">
